...
class Directives {
    ...
    static of(node, onDiagnostic) {
        const found = __classPrivateFieldGet(Directives, _a, "f", _Directives_CACHE).get(node);
        if (found != null) {
            return found;
        }
        const directives = new Directives(node, onDiagnostic);
        __classPrivateFieldGet(Directives, _a, "f", _Directives_CACHE).set(node, directives);
        return directives;
    }
